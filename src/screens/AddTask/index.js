...
const AddTask = () => {
  ...
  const EventsPicker = () => { // repara que esse autocomplete poderia ser reciclado, um componente separado que recebe as coisas e é usado por 500 lugares diferentes
    return (
        <Autocomplete
          data={data}
          value={query}
